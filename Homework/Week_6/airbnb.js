...
var url1 = "http://hopelessoptimism.github.io/interactive-data-viz/data/airbnb/neighbourhoods.geojson";
var url2 = "http://hopelessoptimism.github.io/interactive-data-viz/data/airbnb/listing_count.json";
var url3 = "http://hopelessoptimism.github.io/interactive-data-viz/data/airbnb/neighborhood_reviews_timeseries.csv";

queue()
    .defer(d3.json, 'neighbourhoods.geojson')
    .defer(d3.json, url2)
    .defer(d3.csv, url3)
    .await(draw);
